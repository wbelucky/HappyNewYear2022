...
const main = () => {
  ...
  app.stage.hitArea = {contains(x, y) {
      return 0 <= x && x <= gameWidth && 0 <= y && y <= gameHeight;
  },}
  ...
  const m = {
    "resources/animal_dance.png":         "resources/animal_dance.png",
    "resources/eto_tora_banzai.png":         "resources/eto_tora_banzai.png",
    'resources/food_niku_katamari.png':         'resources/food_niku_katamari.png',
    'resources/animal_tora.png':         'resources/animal_tora.png',
    'resources/profile-circle.png':         'resources/profile-circle.png',
    'resources/game_controller.png':         'resources/game_controller.png',
    'resources/rabbit-vim.png':         'resources/rabbit-vim.png',
    'resources/rabbit-mini.png':         'resources/rabbit-mini.png',
    'resources/turn-arrow.png':         'resources/turn-arrow.png',
  } as const;

  (async () => {
    const entries = await Promise.all(Object.entries(m).map(async ([k, v]) => [k, await Assets.load<PIXI.Texture>(v)]))
